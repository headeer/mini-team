  ...
  return (
    <section className="py-16">
      <div className="max-w-5xl mx-auto text-center px-4">
        ...
        <p className="text-gray-700 mb-6">Masz pytanie dotyczące kompatybilności narzędzi lub cen? Wypełnij formularz, a nasz zespół skontaktuje się w ciągu 24 godzin. Jeśli zależy Ci na pilnej odpowiedzi — zadzwoń do nas.</p>
